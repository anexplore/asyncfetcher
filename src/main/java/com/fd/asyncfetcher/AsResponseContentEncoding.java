 ...
 */
@Immutable
public class AsResponseContentEncoding implements HttpResponseInterceptor {
     ...
     * @since 4.4
     */
    public AsResponseContentEncoding(final Lookup<InputStreamFactory> decoderRegistry) {
     ...
     * </ul>
     */
    public AsResponseContentEncoding() {
        this(null);
    }
